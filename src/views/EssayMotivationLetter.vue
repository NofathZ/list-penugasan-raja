    ...
    <div class="first-container">
        ...
        <div class="second-container container">
            ...
            <div class="form-input">
                <h4><strong>Link Blogspot</strong></h4>
                <input type="text" placeholder="https://www.blogspot.com/....." v-model="jawaban">
...
<script>
    ...
    export default {
        ...
        methods: {
            submitJawaban: function (jawaban) {
                ...
                if (this.jawaban == "" || null) {
                 ...
                 if (this.submit == true) {
                    axios.post('https://rajabrawijaya.ub.ac.id/api/penugasan/motivation_letter/pengumpulan/'+this.nim, {
                        jawaban: jawaban
                    }).then(res => {
                        if (res.data.status) {
                            Swal.fire({
        ...
        mounted(){
            ...
            axios.get('https://rajabrawijaya.ub.ac.id/api/penugasan/status/detail/'+this.nim+'?type=motivation_letter').then((res) => {
                if (res.data.status) {
                    this.$router.push('/').catch(() => {});
                }
            })
