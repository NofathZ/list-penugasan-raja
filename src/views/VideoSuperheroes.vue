...
<script>
    ...
    export default {
        ...
        methods: {
            submitJawaban: function (jawaban) {
                ...
                if (this.jawaban == "") {
                 ...
                 if (this.submit == true) {
                    axios.post('https://rajabrawijaya.ub.ac.id/api/penugasan/video/pengumpulan/' + this.nim + '?type=superheroes', {
        ...
        mounted(){
            ...
            axios.get('https://rajabrawijaya.ub.ac.id/api/penugasan/status/detail/'+this.nim+'?type=superheroes').then((res) => {
                if(res.data.status){
                    this.$router.push('/').catch(() => {});
                }
            })
